            ...
            <div class="backLastest">
              ...
              <el-form class="label">
                <el-form-item label="专业">
                  <el-tag type="info">{{ formData.major }}</el-tag>
                </el-form-item>
              </el-form>
            </div>
            <el-table
...
export default {
  ...
  created () {
    ...
    this.$axios({
      ...
      _this.formData.major = data.major
    })
  },
  methods: {
    ...
    getInfo () {
      ...
      this.$axios({
        ...
        data.forEach(item => {
          if (item.department === this.formData.department && item.major === this.formData.major) {
            let data = {
              term: item.term,
              courseId: item.id,
              courseName: item.courseName,
              credit: item.courseCredit,
              hour: item.courseHour
            }
    ...
    getTermInfo () {
      ...
      this.$axios({
        ...
        datas.forEach(item => {
          if (this.formData.term === item.term && this.formData.department === item.department && this.formData.major === item.major) {
            let data = {
              courseName: item.courseName,
    ...
    queryAll () {
      ...
      this.$axios({
        ...
        const datas = res.data.courses
        datas.forEach(item => {
          if (this.formData.department === item.department && this.formData.major === item.major) {
            let data = {
              courseName: item.courseName,
              courseCredit: item.courseCredit,
              courseHour: item.courseHour,
