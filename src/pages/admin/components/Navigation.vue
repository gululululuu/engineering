<template>
  <div class="Header">
    <ul class="nav">
      ...
      <router-link custom v-slot="{ navigate }" to="/userManage">
        <li @click="navigate" @keypress.enter="navigate" role="link">
          <p>用户管理</p>
        </li>
      </router-link>
      <router-link custom v-slot="{ navigate }" to="/curriculumManage">
        <li @click="navigate" @keypress.enter="navigate" role="link">
          <p>课程管理</p>
        </li>
      </router-link>
      <router-link custom v-slot="{ navigate }" to="/adminPersonalCenter">
